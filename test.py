...
class TestNash(unittest.TestCase):
    ...
    def test_3rd_game(self):
        ...
        self.assertEqual(game_res[0], 3)
        first_condition = np.array_equal(game_res[1], np.array([0, 1, 0, 0])) or \
            np.array_equal(game_res[1], np.array([0, 0, 1, 0])) 
    ...
    def test_4th_game(self):
        ...
        self.assertEqual(game_res[0], 1/2)   
        condition_one = np.array_equal(game_res[1], np.array([1/2, 0, 0, 1/2])) or \
            np.array_equal(game_res[1], np.array([1/4, 1/4, 1/4, 1/4]))
        condition_two = np.array_equal(game_res[2], np.array([1/2, 0, 0, 0, 1/2])) or \
            np.array_equal(game_res[2], np.array([0, 1/2, 0, 1/2, 0]))
    ...
    def test_5th_game(self):
        ...
        self.assertEqual(game_res[0], 1)   
        condition = np.array_equal(game_res[2], np.array([0, 2/3, 1/3])) or \
            np.array_equal(game_res[2], np.array([1/5, 3/5, 1/5]))
        self.assertEqual(condition, True)   
        np.testing.assert_array_equal(game_res[1], np.array([0, 2/3, 1/3]))
    ...
    def test_6th_game(self):
        ...
        self.assertEqual(game_res[0], 0)   
        np.testing.assert_array_equal(game_res[1], np.array([1/3, 1/3, 1/3]))
        np.testing.assert_array_equal(game_res[2], np.array([1/3, 1/3, 1/3]))
    ...
    def test_7th_game(self):
        ...
        self.assertEqual(game_res[0], 2)  
        condition = np.array_equal(game_res[1], np.array([1/2, 1/2, 0])) or \
            np.array_equal(game_res[1], np.array([1/6, 1/6, 2/3]))
        self.assertEqual(condition, True)  
        np.testing.assert_array_equal(game_res[2], np.array([1/2, 1/2, 0]))
    ...
    def test_8th_game(self):
        ...
        self.assertEqual(game_res[0], 9/23)   
        np.testing.assert_array_equal(game_res[1], 
                                      np.array([0, 28/69, 8/23, 17/69]))
        np.testing.assert_array_equal(game_res[2], 
                                      np.array([16/69, 49/138, 19/46]))
    ...
    def test_9th_game(self):
        ...
        self.assertEqual(game_res[0], 91/16)
        np.testing.assert_array_equal(game_res[1], 
                                      np.array([1/8, 11/16, 0, 3/16]))
        np.testing.assert_array_equal(game_res[2], 
                                      np.array([25/48, 19/48, 1/12]))
    ...
    def test_10th_game(self):
        ...
        self.assertEqual(game_res[0], 14/9)
        np.testing.assert_array_equal(game_res[1], 
                                      np.array([4/9, 4/9, 0, 0, 1/9]))
        np.testing.assert_array_equal(game_res[2], 
                                      np.array([1/30, 7/90, 8/15, 16/45]))
